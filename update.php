...
<div class="container" >
  <div class='row'>
    ...
    <input class="form-control form-control-lg" type="text" name="update_text" value="<?php $f_result['task_name'] ?>">
    </div>

    <div class='form-group'>
    <td>
      <img src="images/'.<?php $f_result['image'] ?>.'" value="<?php $f_result['image'] ?>" width="100px" height="100px" alt="">
